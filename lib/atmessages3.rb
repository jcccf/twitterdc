...
class AtMessages3
  ...
  def generate_csv_files(i)
    ...
    mutualin_nbrs_ratios, katz_paths, adamics = {}, {}, {}
    ...
    edges.each do |e1,e2,type|
      ...
      data << [degree_classifier, outdegree_classifier, inoutdegree_classifier, inmsg_classifier, outmsg_classifier, mutualin_nbrs_classifier, adamic_classifier, katz_classifier, reciprocated]
    end
